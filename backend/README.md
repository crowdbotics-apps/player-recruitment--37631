...
## Project Structure
    ...
    ├── player_recruitment__37631  # Django project configurations
...
1. Clone this repo and `cd player_recruitment__37631`
...
2. Clone this repo and `cd player_recruitment__37631`
